...
public class SpeechUtil {
	...
	private static final String APP_ID = "14979764";

	private static final String API_KEY = "zDWG6zuiPisyheGWSnTdaUSi";

	private static final String SECRET_KEY = "4jcEjRC0pK2GhYGXmGj4cqm571Z4YIvP";

	private static AipSpeech client;

	public static void main(String[] args) {
		//合成语音测试
		SpeechSynthesizer("燃烧我的卡路里，燃烧我的卡路里，燃烧燃烧。。燃烧我的卡路里，燃烧你的卡路里，燃烧我的卡路里~~~~~~~~~~~~~燃烧你的卡路里，燃烧你的卡路里，才不要燃烧你的卡路里，当然要燃烧我的卡路里！！！燃烧我的卡路里！！燃烧我的卡路里！！！！！！！！！！！！！", "F:/Speech/luyin.mp3");
		/*//MP3->pcm
		convertMP32Pcm("F:/Speech/luyin1.mp3", "F:/Speech/luyin2.pcm");
		//语音识别
		SpeechRecognition("F:/Speech/luyin2.pcm", "pcm");*/
	}
